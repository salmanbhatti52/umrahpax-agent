                          ...
                          onTap: () async {
                            if (_formKey.currentState!.validate()) {
                              ...
                              var mapData = {
                                ...
                                "password": getProfileResponse != null
                                    ? "${getProfileResponse.data.password}"
                                    : "123456",
                                "agency": businessNameController.text,
                                "address": getProfileResponse != null
                                    ? "${getProfileResponse.data.address}"
                                    : "h1 ",
                                "city": cityController.text,
                                "state": getProfileResponse != null
                                    ? "${getProfileResponse.data.state}"
                                    : "Punjab",
                                "country": getProfileResponse != null
                                    ? "${getProfileResponse.data.country}"
                                    : "Pakistan",
                                "contact": contactNumberController.text,
                                "mobile": getProfileResponse != null
                                    ? "${getProfileResponse.data.mobile}"
                                    : "1234567890",
                                "whatsapp": whatsappNumberController.text,
                                "landline": getProfileResponse != null
                                    ? "${getProfileResponse.data.landline}"
                                    : "1234567890",
                                "notification_switch": getProfileResponse !=
                                        null
                                    ? "${getProfileResponse.data.notificationSwitch}"
                                    : "1234567890"
                              };
                              print("mapData: $mapData");
                              var response = await DioClient()
                                  .updateProfile(mapData, context);
