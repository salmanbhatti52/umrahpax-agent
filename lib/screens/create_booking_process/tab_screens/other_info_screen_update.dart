    ...
    if (getBookingByidResponse != null) {
      for (int i = 0; i < getBookingByidResponse.data!.length; i++) {
        ...
        totalNumberOfPassengers =
            int.parse(getBookingByidResponse.data![i].noOfPassengers!);
        selectedPaymentMethod = getBookingByidResponse.data![i].paymentType!;
        if (selectedPaymentMethod == "cash") {
          cashAmountController.text =
              getBookingByidResponse.data![i].cashReceiveFromCustomer!;
        }
        airlineName = getBookingByidResponse.data![i].flightCompanies!.name!;
        flightnumberController.text =
            getBookingByidResponse.data![i].flightNumber!;
        flightdetailsController.text =
            getBookingByidResponse.data![i].flightDetails!;
        instructionsController.text =
            getBookingByidResponse.data![i].extraInformation!;
        ...
        for (int veh = 0;
            veh < getBookingByidResponse.data![i].vehicles!.length;
            veh++) {
          selectedVehicle =
              getBookingByidResponse.data![i].vehicles![0].vehiclesName!.name!;
          selectedVehicleId = int.parse(
              getBookingByidResponse.data![i].vehicles![0]!.vehiclesId!);

          lenth = getBookingByidResponse.data![i].vehicles!.length;
          if (getBookingByidResponse.data![i].vehicles!.length == 2) {
            selectedVehicle1 =
                getBookingByidResponse.data![i].vehicles![1].vehiclesName!.name;
            selectedVehicle1Id = int.parse(
                getBookingByidResponse.data![i].vehicles![1]!.vehiclesId!);
          }

          if (getBookingByidResponse.data![i].vehicles!.length == 3) {
            selectedVehicle2 =
                getBookingByidResponse.data![i].vehicles![2].vehiclesName!.name;
            selectedVehicle2Id = int.parse(
                getBookingByidResponse.data![i].vehicles![2]!.vehiclesId!);
          }
          if (getBookingByidResponse.data![i].vehicles!.length == 4) {
            selectedVehicle3 =
                getBookingByidResponse.data![i].vehicles![3].vehiclesName!.name;
            selectedVehicle3Id = int.parse(
                getBookingByidResponse.data![i].vehicles![3]!.vehiclesId!);
          }
        }
        print("lnth: ${lenth}");
