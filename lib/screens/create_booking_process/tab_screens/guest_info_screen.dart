...
class GuestInfoPage extends StatefulWidget {
  ...
  GuestInfoPage({
    ...
    this.flightCode1,
    this.dropOffHotel1,
    this.dropOffLocation1,
    this.cashFromGuest,
    this.extraInformation1,
    this.flightCompaniesId1,
    this.flightDetails1,
    this.flightNmbr1,
    this.numberOfAdults1,
    this.numberOfChilds1,
    this.numberOfInfants1,
    this.pickUpData1,
    this.pickupLocation1,
    this.pickUpTime1,
    this.routesDropOffId1,
    this.routesId1,
    this.routesPickUpId1,
    this.serviceType1,
    this.totalFare1,
    this.totalNumberOfPassengers1,
    this.vehicleId1,
    this.vehicleId2,
    this.vehicleId3,
    this.visaType1,
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        FlutterSwitch(
                          ...
                          inactiveColor:
                              const Color(0xFF565656).withOpacity(0.2),
                          toggleSize: 25,
                          value: status,
                          borderRadius: 50,
                          padding: 2,
                                            ...
                                            onTap: () async {
                                              ...
                                              var mapData = {
                                                ...
                                                "routes_id":
                                                    "${widget.routesId1}",
                                                "pickup_location":
                                                    "${widget.routesPickUpId1}",
                                                "dropoff_location":
                                                    "${widget.routesDropOffId1}",
                                                "service_type":
                                                    "${widget.serviceType1}",
                                                "visa_types_id":
                                                    "${widget.visaType1}",
                                                ...
                                                if (widget
                                                    ...
                                                    "cash")
                                                  "cash_from_guest":
                                                      "${widget.cashFromGuest}",
                                                "pickup_date":
                                                    widget.pickUpData1,
                                                "pickup_time":
                                                    widget.pickUpTime1,
                                                "no_of_childs":
                                                    widget.numberOfChilds1,
                                                "no_of_infants":
                                                    widget.numberOfInfants1,
                                                "no_of_adults":
                                                    widget.numberOfAdults1,
                                                "no_of_passengers": widget
                                                    .totalNumberOfPassengers1,
                                                if (widget.extraInformation1!
                                                    .isNotEmpty)
                                                  "extra_information":
                                                      widget.extraInformation1
                                                else
                                                  "extra_information": "hiii",
                                                "vehicle": {
                                                  "0": widget.vehicleId,
                                                  if (widget.vehicleId1 !=
                                                      "null")
                                                    "1": widget.vehicleId1,
                                                  if (widget.vehicleId2 !=
                                                      "null")
                                                    "2": widget.vehicleId2,
                                                  if (widget.vehicleId3 !=
                                                      "null")
                                                    "3": widget.vehicleId3,
                                                },
                                                if (widget.pickupHotel1 !=
                                                    "null")
                                                  "pickup_hotel":
                                                      widget.pickupHotel1,
                                                if (widget.dropOffHotel1 !=
                                                    "null")
                                                  "dropoff_hotel":
                                                      widget.dropOffHotel1,
                                                "booked_fare":
                                                    widget.totalFare1,
                                                ...
                                                "flight_number":
                                                    widget.flightNmbr1,
                                                "flight_companies_id":
                                                    widget.flightCompaniesId1,
                                                "flight_date":
                                                    widget.pickUpData1,
                                                "flight_time":
                                                    widget.pickUpTime1,
                                                "flight_details":
                                                    widget.flightDetails1
